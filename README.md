...
📱 [Download APK for Android](https://github.com/AdrianMalmierca/GeolocationDijonAPI/releases/latest)
...
└── src/
    ...
    └── screens/
        ...
        ├── DetailScreen.tsx         #Show all the information about a commerce, restaurante, cava à vin
        ├── ListScreen.tsx           #Searchable, filterable list with sort
        ├── MapScreen.tsx            #Interactive map with markers and bottom sheet
        ├── PlannerScreen.tsx        #Create your own routes selecting the order of each waypoint
        ├── RouteMapScreen.tsx       #Map where shows the waypoints of the route created by your own with a button to access to Google Maps to follow the route
...
_Built as a portfolio project targeting the French tech market — ESNs and consulting firms in Burgundy/Dijon._
